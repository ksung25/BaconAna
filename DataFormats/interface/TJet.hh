...
namespace baconhep
{
  class TJet : public TObject
  {
    public:
      ...
      qgid(-2),qg1(-2),qg2(-2),q1(-100),q2(-100),
      tau1(-1),tau2(-1),tau3(-1),tau4(-1),
      prunedm(0),
      nCharged(0), nNeutrals(0), nParticles(0),
      beta(0),betaStar(0),dR2Mean(0),ptD(0),q(0),qsq(0),pullPt(0),pullEta(0),pullPhi(0),pullAngle(0),
      ...
      float qgid,qg1,qg2,q1,q2;                                // Quark Gluon Id for jet and subjets
      ...
      float ptD,q,qsq,pullPt,pullEta,pullPhi,pullAngle;      // Additional color flow variables
