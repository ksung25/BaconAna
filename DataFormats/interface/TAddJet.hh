...
namespace baconhep
{
  class TAddJet : public TObject
  {
    public:
      ...
      deepdoubleb(0),deepdoubleb_nomasssculptpen(0),deepdoublec(0),deepdoublec_nomasssculptpen(0),deepdoublecvb(0),deepdoublecvb_nomasssculptpen(0),
    ...
    //float e2_sdb05,e3_sdb05,e3_v1_sdb05,e3_v2_sdb05,e4_v1_sdb05,e4_v2_sdb05;  // Soft Dropped correlation function in puts beta=0.5
      ...
      float deepdoublec,   deepdoublec_nomasssculptpen; 					    	    // Deep double c-tag
      float deepdoublecvb, deepdoublecvb_nomasssculptpen; 					    	    // Deep double cvb-tag
