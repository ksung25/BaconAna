...
namespace baconhep
{
  class TAddJet : public TObject
  {
    public:
      ...
      e2_b1(0),e3_b1(0),e3_v1_b1(0),e3_v2_b1(0),
      e2_b2(0),e3_b2(0),e3_v1_b2(0),e3_v2_b2(0),
      e2_sdb1(0),e3_sdb1(0),e3_v1_sdb1(0),e3_v2_sdb1(0),
      e2_sdb2(0),e3_sdb2(0),e3_v1_sdb2(0),e3_v2_sdb2(0),
      qjet(0),
      ...
      float e2_b1,e3_b1,e3_v1_b1,e3_v2_b1;                                    // Correlation function in puts beta=1
      float e2_b2,e3_b2,e3_v1_b2,e3_v2_b2;                                  // Correlation function in puts beta=2
      float e2_sdb1,e3_sdb1,e3_v1_sdb1,e3_v2_sdb1;                          // Soft Dropped correlation function in puts beta=1
      float e2_sdb2,e3_sdb2,e3_v1_sdb2,e3_v2_sdb2;                          // Soft Dropped correlation function in puts beta=2
